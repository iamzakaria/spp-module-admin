<?php
	include "koneksi.php";
	$kode= $_GET['kode'];
	$queryEdit = mysqli_query($connection,"SELECT * FROM spp where id_spp='$kode' limit 1")or die(mysqli_error());
	$dataEdit = mysqli_fetch_array($queryEdit);
?>
<div id="konten">
<h1>Data Siswa</h1>  
<form method="POST" action="media_admin.php?module=update_proses_spp&amp;kode=<?php echo $dataEdit['id_spp'];?>" align="center" onsubmit="return validasi(this)">
	<table cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			...
			<td>:</td>
			<td><input type="text" name="inputtahun" size="40%" value=<?php echo $dataEdit['tahun'];?>></td>
		</tr>
		<tr>
			<td width="20%">nominal</td>
			<td>:</td>
			<td><input type="text" name="inputnominal" size="40%" value=<?php echo $dataEdit['nominal'];?>></td>
		</tr>
		...
		<tr>
			<td></td>
			<td></td>
			<td><input type="submit" name="tambahspp" value="Update spp">
